...
const Contracts_Address = {
  56: {
    ...
    // 理财
    ManagementAddress: '0x43b163fd41d1e629afefe4c126703d81654a57cf',
    ...
    SwarmLevelRewardAddress: '0x855fCB14d044AfF954d89B129E573B357305d2A6'
  },
  97: {
    ...
    // 理财
    ManagementAddress: '0xcc43d652f506f1c2922138b5db818830f9a81676',
    ...
    // 等级奖励
    SwarmBankLevel1Address: '0xAb689e1F08a77A520FC3eDb8174e3Cf80A55a0C1',
    SwarmBankLevel2Address: '0xAb689e1F08a77A520FC3eDb8174e3Cf80A55a0C1',
    SwarmBankLevel3Address: '0xAb689e1F08a77A520FC3eDb8174e3Cf80A55a0C1',
    SwarmBankLevel4Address: '0xAb689e1F08a77A520FC3eDb8174e3Cf80A55a0C1',
    SwarmBankLevel5Address: '0xAb689e1F08a77A520FC3eDb8174e3Cf80A55a0C1',
    SwarmLevelRewardAddress: '0x2f55eb115bab7b0b217cca19745ba440aae161d9'
  }
};
 ...
 * 理财合约
 */
class contractSwarmUtils_ContractSwarm {
  // 初始化方法
  static init(i18nInstance, messageInstance) {
    contractSwarmUtils_ContractSwarm.i18n = i18nInstance;
    contractSwarmUtils_ContractSwarm.message = messageInstance;
  }
  ...
  static async supply(address, contractsAddress, stakeCount) {
    try {
      ...
      contractSwarmUtils_ContractSwarm.message.success((_ContractSwarm$i18n = contractSwarmUtils_ContractSwarm.i18n) == null ? void 0 : _ContractSwarm$i18n.t('Successful participation'));
      return true;
    } catch (error) {
      console.log("error===>", error);
      return false;
  ...
  static async getUserList(address, managementContract, ratiosContract, recordContract) {
    try {
      const days_1 = await contractSwarmUtils_ContractSwarm.days_1(managementContract);
      const contract = new contractSwarmUtils_web3.eth.Contract(SwarmRecordAbi_namespaceObject, recordContract);
  ...
  static async claim(address, contractsAddress, recordPosition, periodCount) {
    try {
      ...
      contractSwarmUtils_ContractSwarm.message.success((_ContractSwarm$i18n2 = contractSwarmUtils_ContractSwarm.i18n) == null ? void 0 : _ContractSwarm$i18n2.t('Claimed successfully'));
      return true;
    } catch (error) {
      console.log("error===>", error);
      return false;
  ...
  static async sell(address, contractsAddress, amount) {
    try {
      ...
      contractSwarmUtils_ContractSwarm.message.success((_ContractSwarm$i18n3 = contractSwarmUtils_ContractSwarm.i18n) == null ? void 0 : _ContractSwarm$i18n3.t('Sell successful'));
      return true;
    } catch (error) {
      console.log("error===>", error);
      return false;
  ...
  static async dynamicClaim(address, contractsAddress) {
    try {
      ...
      contractSwarmUtils_ContractSwarm.message.success((_ContractSwarm$i18n4 = contractSwarmUtils_ContractSwarm.i18n) == null ? void 0 : _ContractSwarm$i18n4.t('Collection successful, expected to arrive in 1-2 minutes'));
      return true;
    } catch (error) {
      console.log("error===>", error);
      return false;
...
contractSwarmUtils_ContractSwarm.i18n = null;
contractSwarmUtils_ContractSwarm.message = null;
...
const ManagementProvider = _ref => {
  ...
  (0,react.useEffect)(() => {
    contractSwarmUtils_ContractSwarm.init(i18n, message/* default */.Ay);
  }, [i18n]);
  const {
    address
  } = useGetOwnAddress();
  ...
  const handlePerAmount = async () => {
    const amount = await contractSwarmUtils_ContractSwarm.perAmount(ContractsAddress.ManagementAddress);
    setPerAmount(amount);
  };

  // 查询最大交易笔数
  const handleMaxSupply = async () => {
    const amount = await contractSwarmUtils_ContractSwarm.maxSupply(ContractsAddress.ManagementAddress);
    setMaxSupply(amount);
  };
  ...
  const handleEcologyBalance = async () => {
    const ecologyBalanceOf = await contractSwarmUtils_ContractSwarm.balanceOf(address, ContractsAddress.SFI, ContractsAddress.EcologyAddress);
    setEcologySFIBalance(ecologyBalanceOf);
  };

  // 查询当前SFI价格
  const handleSFIPrice = async () => {
    const price = await contractSwarmUtils_ContractSwarm.price(ContractsAddress.RatiosAddress);
    setUsdtSFTprice(price);
  };

  // 查询当前钱包购买理财的数据
  const handleUserList = async () => {
    const getUserList = await contractSwarmUtils_ContractSwarm.getUserList(address, ContractsAddress.ManagementAddress, ContractsAddress.RatiosAddress, ContractsAddress.RecordAddress);
    setLoading(false);
  ...
  const handleStake = async inputAmount => {
    ...
    const stake = await contractSwarmUtils_ContractSwarm.supply(address, ContractsAddress.ManagementAddress, stakeCount);
  ...
  const handleClaim = async (index, recordPosition, periodCount) => {
    ...
    try {
      const status = await contractSwarmUtils_ContractSwarm.claim(address, ContractsAddress.ManagementAddress, recordPosition, periodCount);
      if (status) {
        // 查询SFI余额
        handleSFIBalance();
        // 查询当前钱包购买理财的数据
  ...
  const handleSell = async inputAmount => {
    ...
    const status = await contractSwarmUtils_ContractSwarm.sell(address, ContractsAddress.ManagementAddress, inputAmount);
  ...
  const handleDynamicClaim = async () => {
    ...
    const status = await contractSwarmUtils_ContractSwarm.dynamicClaim(address, ContractsAddress.SwarmDynamicRewardAddress);
...
class ContractSwarmStaking {
  ...
  static async withdraw(address, tokenContract, contractsAddress, amount) {
    try {
      ...
      ContractSwarm.message.success((_ContractSwarm$i18n = ContractSwarm.i18n) == null ? void 0 : _ContractSwarm$i18n.t('Claimed successfully'));
      return true;
    } catch (error) {
      console.log("error===>", error);
      return false;
...
const StakingProvider = _ref => {
  ...
  const [claimableBalance, setClaimableBalance] = (0,react.useState)("0");
...
function dividend_main_Main() {
  ...
  }, !isPromotionLoading && /*#__PURE__*/react.createElement("span", null, t('Claim')), isPromotionLoading && /*#__PURE__*/react.createElement("span", null, /*#__PURE__*/react.createElement(Loader_Dots, null, t('Claim')))))), /*#__PURE__*/react.createElement("div", {
    className: "man_title"
  }, t("Level Reward")), /*#__PURE__*/react.createElement("div", {
    className: "ment_conter"
  }, /*#__PURE__*/react.createElement("div", {
    className: "div_lev_conbotm"
  }, /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("span", null, t("My Level"), ":"), /*#__PURE__*/react.createElement("em", null, "V", teamLevel))), /*#__PURE__*/react.createElement("div", {
    className: "div_lev_pool"
  }, /*#__PURE__*/react.createElement("div", {
    className: "div_lev_flex"
  }, /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("span", null, "V5", t("Reward Pool"), ":"), /*#__PURE__*/react.createElement("em", null, parseNumber(rewardPoolV5), "USDT")), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("span", null, t("Claimable"), ":"), /*#__PURE__*/react.createElement("em", null, "0USDT")))), /*#__PURE__*/react.createElement("div", {
    className: "div_lev_pool"
  }, /*#__PURE__*/react.createElement("div", {
    className: "div_lev_flex"
  }, /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("span", null, "V6", t("Reward Pool"), ":"), /*#__PURE__*/react.createElement("em", null, parseNumber(rewardPoolV6), "USDT")), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("span", null, t("Claimable"), ":"), /*#__PURE__*/react.createElement("em", null, "0USDT")))), /*#__PURE__*/react.createElement("div", {
    className: "div_lev_pool"
  }, /*#__PURE__*/react.createElement("div", {
    className: "div_lev_flex"
  }, /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("span", null, "V7", t("Reward Pool"), ":"), /*#__PURE__*/react.createElement("em", null, parseNumber(rewardPoolV7), "USDT")), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("span", null, t("Claimable"), ":"), /*#__PURE__*/react.createElement("em", null, "0USDT")))), /*#__PURE__*/react.createElement("div", {
    className: "div_lev_pool"
  }, /*#__PURE__*/react.createElement("div", {
    className: "div_lev_flex"
  }, /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("span", null, "V8", t("Reward Pool"), ":"), /*#__PURE__*/react.createElement("em", null, parseNumber(rewardPoolV8), "USDT")), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("span", null, t("Claimable"), ":"), /*#__PURE__*/react.createElement("em", null, "0USDT")))), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("div", {
    className: "div_lev_flex"
  }, /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("span", null, "V9", t("Reward Pool"), ":"), /*#__PURE__*/react.createElement("em", null, parseNumber(rewardPoolV9), "USDT")), /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("span", null, t("Claimable"), ":"), /*#__PURE__*/react.createElement("em", null, "0USDT"))))));
}
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [228], () => (__webpack_require__(5282)))
